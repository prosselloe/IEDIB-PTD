    ...
    public BJ() {
        inicialitzarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ArrayList<Jugador> Jugadors = Jugador.llegirArxiu();
                jugadors = Jugadors.size() - 1;
                ...
                nomJugador.setText(Jugadors.get(partida).getNom());
                nomCroupier.setText(Jugadors.get(0).getNom());
